...
parser.add_argument(
    ...
    help="backend endpoint to POST telemetry to, e.g. "
         "https://<your-app>.onrender.com/predict/eta/broadcast for the deployed instance "
         "(default: http://localhost:8000/predict/eta/broadcast)",
)
...
# local server (e.g. --backend-url https://<your-app>.onrender.com/predict/eta/broadcast).
